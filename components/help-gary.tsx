  ...
  return (
    <div className="flex flex-col justify-center">
      <div className="container mx-auto mt-20 flex flex-col items-center lg:mt-44">
        <Heading className="text-center text-6xl font-bold sm:text-[3.5rem]">Help Gary reach his goals</Heading>
        <Heading className="mt-10 text-center uppercase text-gary-light-blue">1 gara sold = 1 vote</Heading>
      </div>
      ...
      <div className="container mx-auto mt-16 grid justify-center gap-8 lg:grid-cols-[1fr_auto] lg:justify-between">
        ...
        <div className="mt-20 lg:mt-0">
          <div className="sticky top-0">
            ...
            <div className="absolute -left-[150px] top-0 -z-10 hidden h-[363px] w-[324px] 2xl:block">
